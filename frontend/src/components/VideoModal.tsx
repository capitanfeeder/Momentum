          ...
          {result.thumbnail_path ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-surface-400/30">
              <div className="text-center">
                ...
                <p className="text-sm text-slate-500">{t("modal.frameThumbnail")}</p>
              </div>
            </div>
          )}
        ...
        <div className="p-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              <h3 className="text-lg font-semibold text-white mb-1">
                {t("modal.semanticMatch")}
              </h3>
              <p className="text-sm text-slate-400">
                {t("modal.atTimestamp")} {result.timestamp_formatted} (
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-slate-500 font-mono">{t("modal.similarity")}</p>
            </div>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-slate-700/30">
            <div className="grid grid-cols-2 gap-4 text-xs font-mono">
              <div>
                <span className="text-slate-600">{t("modal.videoId")}</span>
                <p className="text-slate-400 mt-0.5 truncate">{result.video_id}</p>
              </div>
              <div>
                <span className="text-slate-600">{t("modal.frameId")}</span>
