...
const STEP_IDS = ["extracting", "detecting", "embedding", "indexing"] as const;
...
export default function ProcessingView({ videoStatus, videoId }: ProcessingViewProps) {
  ...
  const STEP_LABELS = [
    ...
    t("processing.detecting"),
    t("processing.embedding"),
    t("processing.indexing"),
  ];
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">
            {isCompleted ? t("processing.complete") : hasError ? t("processing.failed") : t("processing.title")}
          </h2>
          <p className="text-sm text-slate-400 font-mono">
            {videoId ? `ID: ${videoId.slice(0, 12)}...` : t("processing.initializing")}
          </p>
        ...
        <div className="mt-6 px-6">
          <div className="flex justify-between text-xs font-mono text-slate-500 mb-2">
            <span>
              {videoStatus?.processed_frames || 0} / {videoStatus?.total_frames || 0} {t("processing.frames")}
            </span>
