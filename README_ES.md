...
- Binario de Qdrant ([descargar aca](https://github.com/qdrant/qdrant/releases)) (alternativa para Windows)
...
# Opcion B: Binario (Windows)
# Descargar de https://github.com/qdrant/qdrant/releases
